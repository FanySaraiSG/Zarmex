<x-app-layout>
  @auth('employee')
    ...
    <div class="container mt-5">
      <!-- Botones superiores -->
      <h1 class="text-2xl font-bold" style="color: white; text-align: center;">Categorias</h1>
      <div class="d-flex justify-content-between mb-3">
      <a class="btn btn-secondary btn-sm" href="{{ route('admin.dashboard') }}">Regresar</a>
      <a class="btn btn-success btn-sm" href="{{ route('categorias.create') }}">Añadir Categoría</a>
      </div>
