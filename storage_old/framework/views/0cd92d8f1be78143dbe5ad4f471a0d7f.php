...
<body>
    <header class="topbar">
    <a href="<?php echo e(url('/')); ?>" class="topbar-logo">
        <img src="<?php echo e(asset('imagenes/Captura de pantalla 2025-01-19 134751.png')); ?>" alt="Zarmex">
    </a>
</header>
    ...
    <path d="M4 20c0-4 4-6 8-6s8 2 8 6" stroke="white" stroke-width="1.5"/>
            ...
            <form method="POST" action="<?php echo e(route('employee.login')); ?>" class="login-form">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Dhust\Desktop\AlaEstadia\Zarmex 2\Zarmex original\zarmex\resources\views/auth/employee-login.blade.php ENDPATH**/ ?>