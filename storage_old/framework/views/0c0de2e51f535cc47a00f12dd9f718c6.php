...
<?php if(auth('employee')->user()->rol === 'admin'): ?>
...
<div class="edit-container">
    ...
    <div class="edit-card">
        ...
        <form action="<?php echo e(route('productos.update', $producto->id)); ?>"
              method="POST"
            ...
            <div class="field">
                <label>ID:</label>
                <input type="text" name="id" class="form-control" value="<?php echo e($producto->id); ?>">
            </div>
            ...
            <div class="field">
                <label>Precio:</label>
                <input type="number" step="0.01" name="precio" class="form-control" value="<?php echo e($producto->precio); ?>">
            </div>

            <div class="field">
                <label>Stock:</label>
                <input type="number" name="stock" class="form-control" value="<?php echo e($producto->stock); ?>">
            </div>
                ...
                <select name="categoria_id" class="form-select">
                    <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($categoria->id_categoria); ?>"
                            <?php echo e($producto->categoria_id == $categoria->id_categoria ? 'selected' : ''); ?>>
            ...
            <div class="field">
                ...
                <?php if($producto->imagen_url): ?>
                    <div class="current-img">
                        <img src="<?php echo e(asset($producto->imagen_url)); ?>?v=<?php echo e(time()); ?>" style="max-width:140px;border-radius:12px;">
                    </div>
                <?php endif; ?>
            </div>
            ...
            <?php if(isset($imagenesExtra) && $imagenesExtra->count()): ?>
                <div class="field">
                    <label>Imágenes extra guardadas:</label>
                    <div style="display:flex;gap:10px;flex-wrap:wrap;">
                        <?php $__currentLoopData = $imagenesExtra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <img src="<?php echo e(asset($img->ruta)); ?>?v=<?php echo e(time()); ?>"
...
<div class="docs-box">
    ...
    <div class="mb-3">
        ...
        <?php if($producto->doc1_url): ?>
            <div class="mb-2">
                <a href="<?php echo e(asset($producto->doc1_url)); ?>" target="_blank">Ver documento actual</a>
            </div>
    ...
    <div class="mb-3">
        ...
        <?php if($producto->doc2_url): ?>
            <div class="mb-2">
                <a href="<?php echo e(asset($producto->doc2_url)); ?>" target="_blank">Ver documento actual</a>
            </div>
    ...
    <div class="mb-3">
        ...
        <?php if($producto->doc3_url): ?>
            <div class="mb-2">
                <a href="<?php echo e(asset($producto->doc3_url)); ?>" target="_blank">Ver documento actual</a>
            </div>
        ...
        <input type="file" name="doc3" class="form-control">
            ...
            <div class="button-group">
                ...
                <a href="<?php echo e(route('productos.imagenes.show', $producto->id)); ?>"
...
<?php /**PATH C:\xampp\htdocs\zarmex\resources\views/productos/edit.blade.php ENDPATH**/ ?>