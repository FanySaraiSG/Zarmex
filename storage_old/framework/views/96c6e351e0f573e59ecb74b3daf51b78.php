    ...
    <section>
                ...
                <div class="carousel-inner">
                    ...
                    <?php $__currentLoopData = $bannerImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset($image->imagen_url)); ?>"
                                     class="d-block w-100"
                                     alt="Banner"
                                     style="height:436px; object-fit:cover;">
                            <?php endif; ?>
        ...
        <?php else: ?>
            <div class="content-area">
                <img src="<?php echo e(asset('imagenes/banner.jpeg')); ?>"
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="best-card">
                                                <img src="<?php echo e($topProduct->product->imagen_url ?? asset('Imagenes/84493-4540581.jpg')); ?>"
                                                     alt="<?php echo e($topProduct->product->name ?? 'Producto'); ?>">

                                                <h3><?php echo e($topProduct->product->id); ?></h3>

                                                <p style="text-align: justify;">
                                                    <?php echo e(\Illuminate\Support\Str::limit($topProduct->product->descripcion ?? '', 120)); ?>

                                                </p>

                                                <a href="<?php echo e(route('productos.vermas', ['id' => $topProduct->product->id])); ?>"
                                                   class="best-btn">
                                                    Ver más
                                                </a>
                                            </div>
        ...
        <section class="testimonials py-5">
            <div class="container">
                ...
                <div id="reseñasCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <?php $__currentLoopData = $reseñas->chunk(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="carousel-item <?php echo e($loop->first ? 'active' : ''); ?>">
                                <div class="row">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <div class="card h-100">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"><?php echo e($review->descripcion); ?></p>
                                                    <h5 class="card-title mt-3">
                                                        <?php echo e($review->guest_nombre ? $review->guest_nombre : 'Usuario desconocido'); ?>
...
<?php /**PATH C:\xampp\htdocs\zarmex\resources\views/index.blade.php ENDPATH**/ ?>