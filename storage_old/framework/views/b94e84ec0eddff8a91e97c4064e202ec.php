...
<head>
  ...
  <title><?php echo e(config('app.name', 'Zarmex')); ?> / Nosotros</title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/noso.css')); ?>">
...
<main>
  ...
  <div class="container">
    <div class="nosotros-carousel-container">
      ...
      <?php if(isset($nosotrosBannerImages) && $nosotrosBannerImages->count() > 0): ?>
        ...
        <div id="carouselNosotrosV2"
          ...
          <div class="carousel-indicators">
            <?php $__currentLoopData = $nosotrosBannerImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <button type="button"
          ...
          <div class="carousel-inner">
            <?php $__currentLoopData = $nosotrosBannerImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="carousel-item <?php echo e($i === 0 ? 'active' : ''); ?>">
                <img src="<?php echo e(asset($img->imagen_url)); ?>"
                     class="nosotros-carousel__img"
                     alt="Nosotros <?php echo e($i+1); ?>">
              </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
...
</html><?php /**PATH C:\Users\Dhust\Desktop\AlaEstadia\Zarmex 2\Zarmex original\zarmex\resources\views/nosotros.blade.php ENDPATH**/ ?>