...
<header class="zx-header">
    <div class="zx-bar">
       ...
       <a class="zx-brand" href="<?php echo e(url('/')); ?>">
    <img src="<?php echo e($logoUrl); ?>" alt="Zarmex"
    ...
    <span class="zx-brand-fallback" style="display:none;">ZARMEX</span>
        ...
        <div class="zx-search-wrap" id="zxSearchWrap">
            <form class="zx-search" id="zxSearchForm" action="<?php echo e(route('buscar.resultados')); ?>" method="GET" autocomplete="off">
...
<?php if($isAdminArea): ?>
    ...
    <?php if(auth()->guard('employee')->check()): ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.logo.update')); ?>" enctype="multipart/form-data" class="zx-logo-upload">
            <?php echo csrf_field(); ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.logo.reset')); ?>" class="zx-logo-reset">
            <?php echo csrf_field(); ?>
        ...
        <form method="POST" action="<?php echo e(route('employee.logout')); ?>" class="zx-logout-form">
            <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        ...
        <a class="zx-user" href="<?php echo e(route('employee.login')); ?>" aria-label="Acceso admin" title="Acceso admin">
        ...
        <div class="zx-menu" id="zxMenu">
            <ul class="zx-menu-root">
                ...
                <li class="zx-item zx-has-sub">
                    ...
                    <ul class="zx-sub">
                        <?php $__currentLoopData = App\Models\Categoria::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('categoria.productos', $categoria->id_categoria)); ?>">
                ...
                <li class="zx-item zx-has-sub">
                    ...
                    <ul class="zx-sub">
                        <li><a href="<?php echo e(url('mantenimiento')); ?>">Mantenimiento</a></li>
                        <li><a href="<?php echo e(url('reparación')); ?>">Reparación</a></li>
                    </ul>
                </li>

                
                <li class="zx-item">
                    <a href="<?php echo e(url('/nosotros')); ?>" class="zx-item-link">Nosotros</a>
                </li>
...
<?php /**PATH C:\Users\Dhust\Desktop\AlaEstadia\Zarmex 2\Zarmex original\zarmex\resources\views/header.blade.php ENDPATH**/ ?>